...
struct AuthenticationTests {
    ...
    func cORSValidation() {
        ...
        let allowedOrigins: Set<String> = [
            "https://app.tunnelforge.com",
            "https://*.tunnelforge.com",
            "http://localhost:3000"
        ]

        #expect(isAllowedOrigin("https://app.tunnelforge.com", allowedOrigins: allowedOrigins) == true)
        #expect(isAllowedOrigin("https://dev.tunnelforge.com", allowedOrigins: allowedOrigins) == true)
        ...
        #expect(isAllowedOrigin("http://app.tunnelforge.com", allowedOrigins: allowedOrigins) == false)
    }
}
