...
(async () => {
  ...
  console.log('🌐 Navigating to TunnelForge...');
  ...
  await page.screenshot({ path: 'tunnelforge-debug.png', fullPage: true });
  ...
  console.log('✅ Debug complete. Check tunnelforge-debug.png for screenshot');
