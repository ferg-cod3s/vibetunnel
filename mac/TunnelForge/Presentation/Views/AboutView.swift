...
///
/// This view provides information about TunnelForge including version numbers,
...
struct AboutView: View {
    var appName: String {
        Bundle.main.infoDictionary?["CFBundleDisplayName"] as? String ??
            Bundle.main.infoDictionary?["CFBundleName"] as? String ?? "TunnelForge"
    }
    ...
    private var linksSection: some View {
        VStack(spacing: 10) {
            ...
            HoverableLink(url: "https://x.com/TunnelForge", title: "Follow @TunnelForge", icon: "bird")
        }
    }
