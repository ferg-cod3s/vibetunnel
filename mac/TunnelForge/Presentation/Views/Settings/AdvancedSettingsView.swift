                ...
                Section {
                    ...
                    HStack {
                        VStack(alignment: .leading, spacing: 4) {
                            ...
                            Text("Check for new versions of TunnelForge.")
                                .font(.caption)
                                .foregroundStyle(.secondary)
                        }
...
private struct TerminalPreferenceSection: View {
    ...
    var body: some View {
        Section {
            VStack(alignment: .leading, spacing: 12) {
                ...
                HStack {
                    ...
                    Button("Test") {
                        Task {
                            do {
                                try terminalLauncher.launchCommand("echo 'TunnelForge Terminal Test: Success!'")
                            } catch {
                                // Log the error
                                ...
                                if let terminalError = error as? TerminalLauncherError {
                                    ...
                                    case .appleScriptPermissionDenied:
                                        ...
                                        errorMessage =
                                            "TunnelForge needs permission to control terminal applications.\n\nPlease grant Automation permission in System Settings > Privacy & Security > Automation."
                                    case .accessibilityPermissionDenied:
                                        errorTitle = "Accessibility Permission Required"
                                        errorMessage =
                                            "TunnelForge needs Accessibility permission to send keystrokes to \(Terminal(rawValue: preferredTerminal)?.displayName ?? "terminal").\n\nPlease grant permission in System Settings > Privacy & Security > Accessibility."
            ...
            Text(
                "Configure which applications TunnelForge uses for terminal sessions and Git repositories."
            )
            .font(.caption)
