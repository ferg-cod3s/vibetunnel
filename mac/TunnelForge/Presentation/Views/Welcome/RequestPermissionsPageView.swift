...
///
/// This view guides users through granting necessary permissions for TunnelForge
    ...
    var body: some View {
        VStack(spacing: 30) {
            VStack(spacing: 16) {
                ...
                Text(
                    "TunnelForge needs permissions for automation to start terminal sessions and accessibility to send commands."
                )
                .font(.body)
