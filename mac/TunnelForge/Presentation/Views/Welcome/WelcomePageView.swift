...
/// First page of the welcome flow introducing TunnelForge.
///
/// This view presents the initial onboarding screen with the app icon,
/// welcome message, and brief description of TunnelForge's capabilities.
...
/// - TunnelForge app icon with shadow effect
