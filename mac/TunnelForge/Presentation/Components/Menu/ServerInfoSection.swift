...
///
/// Displays the TunnelForge logo, server running status, and available
...
struct ServerInfoHeader: View {
    ...
    private var appDisplayName: String {
        ...
        var name = debugMode ? "TunnelForge Debug" : "TunnelForge"
...
/// the TunnelForge server is currently running or stopped.
