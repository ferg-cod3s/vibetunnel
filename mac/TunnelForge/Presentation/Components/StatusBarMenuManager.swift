...
final class StatusBarMenuManager: NSObject {
    ...
    func showCustomWindow(relativeTo button: NSStatusBarButton) {
        ...
        let mainView = TunnelForgeMenuView(isNewSessionActive: sessionBinding)
    ...
    func showContextMenu(for button: NSStatusBarButton, statusItem: NSStatusItem) {
        ...
        if let serverManager {
            ...
            restartItem.isEnabled = serverManager.isRunning
        ...
        let aboutItem = NSMenuItem(title: "About TunnelForge", action: #selector(showAbout), keyEquivalent: "")
        ...
        // Quit
        let quitItem = NSMenuItem(title: "Quit TunnelForge", action: #selector(quitApp), keyEquivalent: "q")
