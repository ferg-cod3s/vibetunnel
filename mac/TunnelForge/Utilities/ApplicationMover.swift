...
final class ApplicationMover {
    ...
    private func offerToMoveToApplications() {
        let alert = NSAlert()
        alert.messageText = "Move TunnelForge to Applications?"
        let informativeText = "TunnelForge is currently running from a disk image or temporary location. " +
    ...
    private func performMoveToApplications() {
        ...
        let appName = Bundle.main.infoDictionary?["CFBundleName"] as? String ?? "TunnelForge"
    ...
    private func showMoveSuccessAndRelaunch(newPath: String) {
        ...
        let informativeText = "TunnelForge has been moved to Applications. " +
    ...
    private func showMoveError(_ error: Error) {
        ...
        alert.informativeText = "Could not move TunnelForge to Applications: \(error.localizedDescription)"
    ...
    private func showLaunchError(_ error: Error) {
        ...
        let informativeText = "Could not launch TunnelForge from Applications: \(error.localizedDescription)\n\n" +
