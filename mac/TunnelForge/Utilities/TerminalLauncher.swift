...
///
/// Represents terminal emulators that TunnelForge can launch
...
enum TerminalLauncherError: LocalizedError {
    ...
    var failureReason: String? {
        switch self {
        case .appleScriptPermissionDenied:
            return "TunnelForge needs Automation permission to control terminal applications."
        case .accessibilityPermissionDenied:
            return "TunnelForge needs Accessibility permission to send keystrokes to terminal applications."
...
final class TerminalLauncher {
        ...
        throws
    {
        ...
        let bunServerActive = Bundle.main.path(forResource: "tunnelforge-server", ofType: nil) != nil &&
        ...
        if bunServerActive {
            ...
            let tunnelforge = vibetunnelPath ?? findTunnelForgeBinary()
            ...
            if command.contains("TTY_SESSION_ID=") {
                ...
                fullCommand = "cd \"\(escapedDir)\" && TTY_SESSION_ID=\"\(sessionId)\" \(vibetunnelPath ?? "vibetunnel") \(command) && exit"
            }
        }
    ...
    private func findTunnelForgeBinary() -> String {
        ...
        return "echo 'TunnelForge: tunnelforge binary not found in app bundle'; false"
    }
    ...
    private func findBunExecutable() -> String {
        ...
        return "echo 'TunnelForge: Bun executable not found in app bundle'; false"
    }
