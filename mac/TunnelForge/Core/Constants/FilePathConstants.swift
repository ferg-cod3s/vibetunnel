...
enum FilePathConstants {
    ...
    static let applicationsTunnelForge = "/Applications/TunnelForge.app"
    static let userApplicationsTunnelForge = "$HOME/Applications/TunnelForge.app"
    ...
    static let entitlements = "TunnelForge.entitlements"
