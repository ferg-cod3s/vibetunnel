...
enum BundleIdentifiers {
    ...
    static let main = "dev.tunnelforge.tunnelforge"
    static let vibeTunnel = "dev.tunnelforge.tunnelforge"

    /// Logging subsystem identifier for unified logging
    static let loggerSubsystem = "dev.tunnelforge.tunnelforge"
    ...
    /// from TunnelForge for repository editing.
    enum Editor {
        static let vsCode = "com.microsoft.VSCode"
        static let windsurf = "com.codeiumapp.windsurf"
    }
