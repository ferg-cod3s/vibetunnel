...
///
/// This struct manages user preferences for TunnelForge, including
/// preferred applications for Git and terminal operations, UI preferences,
/// and update settings.
struct AppPreferences {
    /// The preferred Git GUI application.
    ///
    /// When set, TunnelForge will use this application to open Git repositories.
    ...
    ///
    /// When set, TunnelForge will use this terminal for opening new sessions.
    /// Common values include:
    ...
    /// Whether to show TunnelForge in the macOS Dock.
    ///
