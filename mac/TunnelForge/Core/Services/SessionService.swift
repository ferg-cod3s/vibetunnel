...
final class SessionService {
    ...
    /// 2. Closes the terminal window if it was opened by TunnelForge
    ///
    ...
    /// However, it only closes windows that TunnelForge opened via AppleScript,
    ...
    func terminateSession(sessionId: String) async throws {
        ...
        // that TunnelForge created, not externally attached sessions.
