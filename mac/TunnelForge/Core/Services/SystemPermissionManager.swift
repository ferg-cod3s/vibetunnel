...
/// Types of system permissions that TunnelForge requires.
///
...
/// Unified manager for all system permissions required by TunnelForge.
///
...
final class SystemPermissionManager {
    ...
    func showPermissionAlert(for permission: SystemPermission) {
        ...
        TunnelForge needs \(permission.displayName) permission.
