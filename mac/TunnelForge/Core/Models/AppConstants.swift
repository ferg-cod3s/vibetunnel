...
enum AppConstants {
    ...
    enum UserDefaultsKeys {
        ...
        static let useExternalGoServer = "useExternalGoServer"
    ...
    static func boolValue(for key: String) -> Bool {
        ...
        if UserDefaults.standard.object(forKey: key) == nil {
            ...
            case UserDefaultsKeys.useExternalGoServer:
                return Defaults.useExternalGoServer
