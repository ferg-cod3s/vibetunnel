...
#
# OUTPUT:
#   - GitHub release at: https://github.com/ferg-cod3s/tunnelforge/releases
...
For details, please see the [CHANGELOG](https://github.com/ferg-cod3s/tunnelforge/blob/main/CHANGELOG.md).
...
echo "  - Build: $BUILD_NUMBER"
echo "  - Tag: $TAG_NAME"
echo "  - GitHub: https://github.com/ferg-cod3s/tunnelforge/releases/tag/$TAG_NAME"
echo ""
